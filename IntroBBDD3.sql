--3. Escribe una consulta que extraiga todas las columnas de los datos de los modelos 
--de aviones disponibles (aircraft_data).

SELECT *
FROM aircrafts_data;
-- No necesitamos un WHERE porque no se especifican condiciones adicionales.
